...
struct Window
{
    ...
    bool Create(const char* windowTitle,
                ...
                const bool initForGL = false,
                const bool autoShow = true);
    bool NextMessage(MSG* msg, const bool thisWindowOnly = false);
    void Destroy();
    void Show();
    void Hide();
...
bool Window::Create(const char* windowTitle,
                    const uint32_t x,
                    const uint32_t y,
                    const uint32_t width,
                    const uint32_t height,
                    const bool initForGL,
                    const bool autoShow)
{
